...
// Get some stats
$total_opps = $conn->query("SELECT COUNT(*) as count FROM opportunities WHERE company_id = $company_id")->fetch_assoc()['count'];
$pending_opps = $conn->query("SELECT COUNT(*) as count FROM opportunities WHERE company_id = $company_id AND status = 'pending'")->fetch_assoc()['count'];
$total_apps = $conn->query("SELECT COUNT(*) as count FROM applications a JOIN opportunities o ON a.opportunity_id = o.id WHERE o.company_id = $company_id")->fetch_assoc()['count'];
?>
...
<head>
    ...
    <style>
        ...
        .sidebar h2 { text-align: center; margin-bottom: 30px; font-size: 1.2em; }
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <a href="add_opportunity.php" class="btn btn-primary">+ Post New Opportunity</a>
        </div>

        <div class="stats">
            <div class="stat-card">
                <h3>Total Posted</h3>
                <p><?php echo $total_opps; ?></p>
            </div>
            <div class="stat-card">
                <h3>Pending Approval</h3>
                <p><?php echo $pending_opps; ?></p>
            </div>
            <div class="stat-card">
