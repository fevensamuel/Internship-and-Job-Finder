...
$my_apps = $appModel->getStudentApplications($_SESSION['user_id']);
?>
...
<head>
    ...
    <style>
        ...
        .accepted { background: #e8f8f5; color: #1abc9c; }
...
<body>
    <div class="sidebar">
        ...
        <a href="my_applications.php" style="background:#34495e">My Applications</a>
    ...
    <div class="main-content">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($row['status'] == 'accepted'): ?>
                            <span style="color:#2ecc71; font-weight:bold;"><?php echo $row['company_email']; ?></span>
                        <?php else: ?>
                            <span style="color:#95a5a6; font-style:italic;">Hidden until accepted</span>
                        <?php endif; ?>
                    </td>
                ...
                <tr><td colspan="5" style="text-align:center">You haven't applied to any jobs yet.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
